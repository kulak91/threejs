...
function init() {
  ...
  const texture = new THREE.TextureLoader().load( 'assets/minecraft/atlas.png' );
...
//     controls.lookSpeed = 0.125; // Enable look when the mouse is moving;

//     setTimeout(() => { controls.lookSpeed = 0 }, 2000)
//   // } else {
//     // controls.lookSpeed = 0; // Disable look when the mouse is idle
//   // }
// });
